...
### 3 - open land --------------------------------------------------------------------
land <- readOGR(dsn = paste(sourcedir, "Map_files", sep = "/"), layer = "Land")
...
#### ------- EVALUATE PRED ------- ####
#### ----------------------------- ####
source(paste(funcdir, "make_cfact_2.R", sep = "/"))
source(paste(funcdir, "rescale2.R", sep = "/"))
library(assertthat)
library(WhatIf)
